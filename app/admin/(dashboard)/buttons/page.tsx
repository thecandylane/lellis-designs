    ...
    <div className="max-w-6xl mx-auto">
      ...
      {buttons.length === 0 ? (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-1">No buttons yet</h3>
          <p className="text-gray-500 mb-4">Upload your first button designs to get started!</p>
          <Link
            href="/admin/upload"
...
function ButtonCard({ button }: { button: PayloadButton }) {
  ...
  return (
    <div className={`bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden ${!button.active ? 'opacity-60' : ''}`}>
      {/* Image */}
      ...
      {/* Info */}
      <div className="p-3">
        <h3 className="font-medium text-gray-900 truncate">{button.name}</h3>
