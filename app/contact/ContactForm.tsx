...
type Props = {
  ...
  contactSubjectOptions?: SubjectOption[]
...
export default function ContactForm({
  ...
  contactSuccessMessage = 'Thanks for reaching out! We\'ll get back to you as soon as possible, usually within 24 hours.',
}: Props) {
    ...
    return (
      <div className={`min-h-screen flex items-center justify-center p-4 ${!hasBackgroundImage ? 'bg-glow' : ''}`}>
        ...
        <div className="max-w-md w-full bg-card rounded-2xl shadow-lg p-8 text-center border border-border">
          ...
          <h1 className="text-2xl font-semibold text-foreground mb-3">{contactSuccessTitle}</h1>
