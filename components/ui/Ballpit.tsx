...
class Y extends MeshPhysicalMaterial {
  ...
  onBeforeCompile2?: (shader: YShader) => void

  constructor(params: ConstructorParameters<typeof MeshPhysicalMaterial>[0]) {
    super(params)
    this.defines = { USE_UV: '' }
    this.onBeforeCompile = (shader: YShader) => {
...
const DefaultConfig: BallpitConfig = {
  count: 200,
  colors: [0x14b8a6, 0xec4899, 0x84cc16],
...
const Ballpit: React.FC<BallpitProps> = ({
  ...
  }, [followCursor, count, colors, gravity, friction, wallBounce, maxVelocity, minSize, maxSize])
